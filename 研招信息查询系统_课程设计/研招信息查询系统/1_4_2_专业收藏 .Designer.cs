namespace 研招信息查询系统
{
    partial class 专业收藏Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.移除研招信息button = new System.Windows.Forms.Button();
            ...
            // 移除研招信息button
            // 
            this.移除研招信息button.Location = new System.Drawing.Point(1075, 169);
            this.移除研招信息button.Name = "移除研招信息button";
            this.移除研招信息button.Size = new System.Drawing.Size(132, 50);
            this.移除研招信息button.TabIndex = 3;
            this.移除研招信息button.Text = "移除研招信息";
            this.移除研招信息button.UseVisualStyleBackColor = true;
            this.移除研招信息button.Click += new System.EventHandler(this.移除研招信息button_Click);
            // 
            // 返回button
            // 
            ...
            this.Controls.Add(this.移除研招信息button);
            ...
            this.Text = "专业收藏";
            this.Load += new System.EventHandler(this.专业收藏Form_Load);
            this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.专业收藏Form_KeyPress);
        ...
        private System.Windows.Forms.Button 移除研招信息button;
